...
User should NOT be able to INSERT into the `sandbox_public.critical_stuff` table.
  ...
  > "
  SET
  ERROR:  permission denied for table critical_stuff
  [1]

User should NOT be able to UPDATE the `sandbox_public.critical_stuff` table.
